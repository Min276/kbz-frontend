...
const NavBar = () => {
    ...
    return(
        ...
        <div className="flex px-48 justify-between items-center p-4 shadow bg-[#DFF6FF]">
         ...
         <h6 className="text-sm">
         <a href="mailto: admin@kbzmoney.com" className="flex items-center gap-2">
            admin@kbzmoney.com
        ...
        <div className="flex px-48 justify-between items-center shadow bg-white">
           ...
           <div className="flex items-center">
           <input ref={inputRef} autoFocus={open} style={{ display: open ? "flex" : "none"}} type="search" placeholder="Search here" className="py-2 px-3 text-lg mr-4 border-2 rounded-md"></input>
